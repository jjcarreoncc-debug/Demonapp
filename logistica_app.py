...
def logistica_app():
    ...
    # FILES
    # =========================
    archivo_transito = st.file_uploader("🚛 Tránsito", type=["xlsx"], key="transito_file")
    archivo_bodegas = st.file_uploader("🏬 Bodegas", type=["xlsx"], key="bodegas_file_log")
    archivo_transportistas = st.file_uploader("🚚 Transportistas", type=["xlsx"], key="transportistas_file")
    archivo_rutas = st.file_uploader("🛣️ Rutas", type=["xlsx"], key="rutas_file")
    archivo_recepcion = st.file_uploader("📥 Recepción", type=["xlsx"], key="recepcion_file")
    archivo_despachos = st.file_uploader("📤 Despachos", type=["xlsx"], key="despachos_file")
    ...
    if st.session_state.logistica_vista == "dashboard":
        dashboard_logistica(transito, bodegas, transportistas)
        ...
        indicadores_logistica_app(transito, recepcion, despachos, transportistas, rutas)
