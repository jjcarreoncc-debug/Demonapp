...
# =====================================
# RECREAR TABLA AUDITORIA (TEMPORAL)
# =====================================
conn = get_connection()
cursor = conn.cursor()
...
def consultar_auditoria_app():
    ...
    try:
        ...
        st.error(
            "❌ No se pudo leer la auditoría desde la base de datos."
        )
    ...
    if filtro_usuario != "Todos":
        ...
        df_filtrado = df_filtrado[
            df_filtrado["usuario"].astype(str)
            == filtro_usuario
        ]
