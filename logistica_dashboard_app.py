...
def dashboard_logistica(
    ...
    estado_resumen.columns = ["ESTADO_TRANSITO", "TOTAL"]
    ...
    with tab1:
        ...
        with c2:
            st.metric("📦 Unidades Movimiento", f"{unidades_transito:,}")
        with c3:
    ...
    with tab2:
        ...
        st.bar_chart(estado_resumen.set_index("ESTADO_TRANSITO")["TOTAL"])
    ...
    with tab5:
        ...
        st.metric("🔴 Retrasados", len(retrasados))
        st.dataframe(retrasados, use_container_width=True)
