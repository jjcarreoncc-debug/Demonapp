...
from mantenimiento_modulos_app import administrar_modulos_app
...
def mantenimiento_app():
    ...
    st.title("🛠️ Mantenimiento")
    st.caption("Administración / Seguridad / Configuración del sistema")
    ...
    st.markdown("---")
    st.caption(f"Ruta: Mantenimiento / {menu} / {submenu}")
    ...
    if menu == "👥 Usuarios" and submenu == "Crear usuario":
        ...
        st.warning(f"Pantalla en construcción: {submenu}")
